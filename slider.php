    ...
    <div id="slider1_container" style="position: relative; width: 475px;
        ...
        <div u="slides" style="cursor: move; position: absolute; border-radius:5px; border:1px solid #aaa; left: 0px; top: 0px; width: 600px; height: 300px;
            overflow: hidden;">
			<div>
                <img u=image src="images/a.jpg" />
                <div u="thumb" style="">Sedang mencari jurnal atau skripsi ?</div>
                <div u="caption" t="L" style="position: absolute; top: 20px; left: 20px; width: 200px; height: 30px; color: #ffffff; font-size: 20px; line-height: 30px;">Cari semuanya di E-Research System</div>
            ...
            <div>
                <img u=image src="images/b.jpg" />
                <div u="thumb">Cari Skripsi</div>
                <div u="caption" t="MCLIP|L" style="position: absolute; top: 105px; left: 100px; width: 400px; height: 30px; color: #ffffff; font-size: 26px; line-height: 30px; text-align: center;">Seminar Fakultas Hukum</div>
                <div u="caption" t="LISTH|L" style="position: absolute; top: 165px; left: 100px; width: 400px; height: 30px; color: #ffffff; font-size: 26px; line-height: 30px; text-align: center;"></div>
            </div>
            <div>
                <img u=image src="images/c.jpg" />
                <div u="thumb">Cari Jurnal</div>
			</div>
            <div>
                <img u=image src="images/d.jpg" />
                <div u="thumb">Cari Makalah</div>
                 </div>
            <div>
                <img u=image src="images/e.jpg" />
                <div u="thumb">Cari Karya Ilmiah</div>
                <div u="caption" t="DDG|TR" style="position: absolute; top: 135px; left: 100px; width: 150px; height: 30px; color: #ffffff; font-size: 26px; line-height: 30px; text-align: center;">E-Reasearch UNSIKA</div>
            ...
            <div>
                <img u=image src="images/f.jpg" />
                <div u="thumb">Cari Paper</div>
                </div>
            <div>
                <img u=image src="images/g.jpg" />
                <div u="thumb">Cari Proposal</div>
            </div>
            <div>
                <img u=image src="images/h.jpg" />
               <div u="thumb">Cari Ebook</div>
